...
#define PM_NODE_BLOCK(p)      (((p)>>2)>>PAGE_PER_BLOCK_SHIFT)   // p/256
...
//jsjpenn
#define RECORD_START_BLOCK (PMT_START_BLOCK+PMT_BLOCK_COUNT)//46
#define RECORD_BLOCK_COUNT (8)//为保存MAPI，预留8个LEB块

#define DATA_START_BLOCK   (RECORD_START_BLOCK+RECORD_BLOCK_COUNT)//54
